...
import 'package:foodecom/model/RestaurantsList.dart';
                ...
                children: [
                  ...
                  Row(
                    children: [
                      Padding(
                        padding: const EdgeInsets.only(left: 0,right: 2),
                        child: Text(data.type.toString(),style: TextStyle(color: placeholderColor),),
                      ),
                      Padding(
                        padding: const EdgeInsets.only(left: 2),
                        child: Text(".",style: TextStyle(color: mainColor,fontWeight: FontWeight.bold,fontSize: 15),),
                      ...
                      Padding(
                        ...
                        child: Text(data.label.toString(),style: TextStyle(color: placeholderColor),),
                      ),
                      Icon(Icons.star,color: mainColor,size: 15,),
                      Padding(
                        padding: const EdgeInsets.only(left: 2),
                        child: Text(data.rating.toString(),style: TextStyle(color: mainColor,fontWeight: FontWeight.bold),),
                      ),
...
class RecentItems extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView.separated(
      separatorBuilder: (context,index){
        return SizedBox(height: kVerticalPadding/2,);
      },
      padding: EdgeInsets.symmetric(horizontal: 23),
      physics: BouncingScrollPhysics(),
      scrollDirection: Axis.vertical,
            ...
            Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Padding(
                      padding: const EdgeInsets.only(left: 0,right: 2,bottom: 4),
                      child: Text(data.type.toString(),style: TextStyle(color: placeholderColor),),
                    ),
                    Padding(
